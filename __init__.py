"""MDPack — eigene ComfyUI-Nodes (Quality Gate, Hand/Foot-Montage, JSON→Text, OpenRouter Chunked Prompts, Key-Value Dropdown, Atlas Cloud API, Character Fanout, Provenance Save, Local Chunked Prompts, Resolution Selector)."""
...
NODE_CLASS_MAPPINGS = {**_N1, **_N2, **_N3, **_N4, **_N5, **_N6, **_N7, **_N8, **_N9, **_N10}
NODE_DISPLAY_NAME_MAPPINGS = {**_D1, **_D2, **_D3, **_D4, **_D5, **_D6, **_D7, **_D8, **_D9, **_D10}
